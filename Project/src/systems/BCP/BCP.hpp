...
#include "../../parameters/BCP/BCPPublickey.hpp"
#include "../../parameters/BCP/BCPSecretkey.hpp"
#include "../../parameters/BCP/BCPPlaintext.hpp"
#include "../../parameters/BCP/BCPCiphertext.hpp"
...
class BCP
{
    ...
    void           init     (const int MS, const int ES, const mpz_t modulus, const mpz_t prime1, const mpz_t prime2);
...
inline void BCP::init(const int MS, const int ES, const mpz_t modulus, const mpz_t prime1, const mpz_t prime2)
{
    modbits = MS;
    ebits = ES;
    mpz_set(N, modulus);
